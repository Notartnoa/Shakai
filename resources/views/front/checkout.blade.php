...
@section('content')
    ...
    <section id="checkout" class="container max-w-[1130px] mx-auto mt-[30px] mb-[100px]">
        <div class="w-full flex justify-center gap-[60px]">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 rounded-full flex shrink-0 overflow-hidden">
                                    <img src="{{ Storage::url($product->Creator->avatar) }}" class="w-full h-full object-cover" alt="creator">
                                </div>
            ...
            {{-- Payment Card --}}
            <div class="flex flex-col p-[30px] gap-[30px] rounded-[20px] w-[450px] border-2 border-belibang-darker-grey h-fit">
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <p class="font-semibold text-2xl bg-clip-text text-transparent bg-gradient-to-r from-[#B05CB0] to-[#FCB16B]">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <p class="text-sm text-belibang-grey">
                        Click the button below to proceed with payment. You can pay using various methods including bank transfer, e-wallet, credit card, and more.
                    </p>

                    {{-- Payment logos --}}
                    <div class="flex flex-wrap gap-3 items-center">
                        <div class="p-2 bg-white rounded-lg">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Logo_dana_blue.svg/120px-Logo_dana_blue.svg.png" class="h-5 object-contain" alt="DANA">
                        </div>
                        <div class="p-2 bg-white rounded-lg">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Logo_ovo_purple.svg/120px-Logo_ovo_purple.svg.png" class="h-5 object-contain" alt="OVO">
                        </div>
                        <div class="p-2 bg-white rounded-lg">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Gopay_logo.svg/120px-Gopay_logo.svg.png" class="h-5 object-contain" alt="GoPay">
                        </div>
                        <div class="p-2 bg-white rounded-lg">
