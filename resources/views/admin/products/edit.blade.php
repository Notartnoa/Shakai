                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="description" rows="4"
                            class="w-full py-2 px-3 border rounded @error('about') border-red-500 @enderror">{{ old('about', $product->about) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="price" class="block mt-1 w-full @error('price') border-red-500 @enderror"
                            ...
                            placeholder="50000" />
                        <p class="text-xs text-gray-500 mt-1">Enter price in IDR (Indonesian Rupiah)</p>
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id"
                            class="w-full py-2 pl-5 border rounded @error('category_id') border-red-500 @enderror">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            ...
                            <label for="cover" id="thumbnail-label"
                                ...
                                <div id="upload-placeholder" class="hidden flex-col items-center justify-center p-8 text-center">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            ...
                            <label for="detail_images" id="detail-images-label"
                                class="flex flex-col items-center justify-center w-full min-h-[280px]
                                ...
                                <div class="w-20 h-20 mb-4 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600
                                            flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                    <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                              d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                ...
                                <p class="text-sm text-gray-500 text-center">
                                    Select 1-4 images • Recommended: 1600x1360px • Max 4MB each
                                </p>
                                <div class="mt-4 flex items-center gap-2 text-xs text-gray-400">
                                    <span class="px-3 py-1 bg-white/60 rounded-full">PNG</span>
                                    <span class="px-3 py-1 bg-white/60 rounded-full">JPG</span>
                                    <span class="px-3 py-1 bg-white/60 rounded-full">JPEG</span>
                                </div>
                            </label>
                    ...
                    <div class="mt-6">
                        <div class="flex items-center justify-between mb-2">
                            <x-input-label for="path_file" :value="__('Product File (ZIP)')" />
                            <span class="text-xs text-gray-500">Max 10MB • ZIP only</span>
                        </div>
                        ...
                        @if ($product->path_file)
                            <div class="mb-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                <p class="text-sm text-gray-600">
                                    ...
                                    <span class="text-indigo-600">{{ basename($product->path_file) }}</span>
                                </p>
                            </div>
                        @endif

                        <div class="relative">
                            <input type="file" id="path_file" name="path_file" accept=".zip"
                                class="hidden" onchange="handleZipFile(event)">

                            <label for="path_file" id="zip-label"
                                class="flex items-center justify-between w-full p-4
                                       border-2 border-dashed @error('path_file') border-red-300 @else border-gray-300 @enderror rounded-xl cursor-pointer
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500 to-pink-600
                                                flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-700" id="zip-filename">Click to upload new ZIP file</p>
                                        <p class="text-xs text-gray-500">Product files, source code, assets, etc. (Max 10MB)</p>
                                    </div>
                                </div>
                        ...
                        <p class="text-xs text-gray-500 mt-2">Leave empty if you don't want to replace the file.</p>
                    ...
                    <div class="mt-6">
                        ...
                        @php
                            ...
                            // Kalau ada old() (misal form error), pakai itu
                            $selectedFormats = old('file_formats');

                            // Kalau tidak ada old(), pakai dari product->file_formats (comma separated)
    ...
    <script>
        ...
        function handleZipFile(event) {
            ...
            if (file) {
                ...
                document.getElementById('zip-filename').textContent = `${filename} (${filesize} MB)`;
            }
        }
